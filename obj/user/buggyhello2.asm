...
libmain(int argc, char **argv)
{
  ...
  800068:	e8 d8 00 00 00       	call   800145 <sys_getenvid>
...
exit(void)
{
  ...
  8000af:	e8 3f 00 00 00       	call   8000f3 <sys_env_destroy>
}
  8000b4:	c9                   	leave  
  8000b5:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  800113:	7e 28                	jle    80013d <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800115:	89 44 24 10          	mov    %eax,0x10(%esp)
  800119:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800120:	00 
  800121:	c7 44 24 08 b8 10 80 	movl   $0x8010b8,0x8(%esp)
  800128:	00 
  800129:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800130:	00 
  800131:	c7 04 24 d5 10 80 00 	movl   $0x8010d5,(%esp)
  800138:	e8 5b 02 00 00       	call   800398 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a5:	7e 28                	jle    8001cf <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001a7:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001ab:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  8001b2:	00 
  8001b3:	c7 44 24 08 b8 10 80 	movl   $0x8010b8,0x8(%esp)
  8001ba:	00 
  8001bb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001c2:	00 
  8001c3:	c7 04 24 d5 10 80 00 	movl   $0x8010d5,(%esp)
  8001ca:	e8 c9 01 00 00       	call   800398 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f8:	7e 28                	jle    800222 <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001fa:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001fe:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800205:	00 
  800206:	c7 44 24 08 b8 10 80 	movl   $0x8010b8,0x8(%esp)
  80020d:	00 
  80020e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800215:	00 
  800216:	c7 04 24 d5 10 80 00 	movl   $0x8010d5,(%esp)
  80021d:	e8 76 01 00 00       	call   800398 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024b:	7e 28                	jle    800275 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80024d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800251:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800258:	00 
  800259:	c7 44 24 08 b8 10 80 	movl   $0x8010b8,0x8(%esp)
  800260:	00 
  800261:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800268:	00 
  800269:	c7 04 24 d5 10 80 00 	movl   $0x8010d5,(%esp)
  800270:	e8 23 01 00 00       	call   800398 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80029e:	7e 28                	jle    8002c8 <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002a0:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002a4:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  8002ab:	00 
  8002ac:	c7 44 24 08 b8 10 80 	movl   $0x8010b8,0x8(%esp)
  8002b3:	00 
  8002b4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002bb:	00 
  8002bc:	c7 04 24 d5 10 80 00 	movl   $0x8010d5,(%esp)
  8002c3:	e8 d0 00 00 00       	call   800398 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002de:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8002f1:	7e 28                	jle    80031b <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002f3:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002f7:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8002fe:	00 
  8002ff:	c7 44 24 08 b8 10 80 	movl   $0x8010b8,0x8(%esp)
  800306:	00 
  800307:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80030e:	00 
  80030f:	c7 04 24 d5 10 80 00 	movl   $0x8010d5,(%esp)
  800316:	e8 7d 00 00 00       	call   800398 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800328:	53                   	push   %ebx
	...
	asm volatile("int %1\n"
  800329:	be 00 00 00 00       	mov    $0x0,%esi
  80032e:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800354:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  800366:	7e 28                	jle    800390 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800368:	89 44 24 10          	mov    %eax,0x10(%esp)
  80036c:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800373:	00 
  800374:	c7 44 24 08 b8 10 80 	movl   $0x8010b8,0x8(%esp)
  80037b:	00 
  80037c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800383:	00 
  800384:	c7 04 24 d5 10 80 00 	movl   $0x8010d5,(%esp)
  80038b:	e8 08 00 00 00       	call   800398 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80039d:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  8003a0:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8003a3:	8b 35 04 20 80 00    	mov    0x802004,%esi
  8003a9:	e8 97 fd ff ff       	call   800145 <sys_getenvid>
  ...
  8003bc:	89 74 24 08          	mov    %esi,0x8(%esp)
  8003c0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8003c4:	c7 04 24 e4 10 80 00 	movl   $0x8010e4,(%esp)
  8003cb:	e8 c1 00 00 00       	call   800491 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8003d0:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8003d4:	8b 45 10             	mov    0x10(%ebp),%eax
  8003d7:	89 04 24             	mov    %eax,(%esp)
  8003da:	e8 51 00 00 00       	call   800430 <vcprintf>
	cprintf("\n");
  8003df:	c7 04 24 ac 10 80 00 	movl   $0x8010ac,(%esp)
  8003e6:	e8 a6 00 00 00       	call   800491 <cprintf>
...
putch(int ch, struct printbuf *b)
{
  ...
  8003f5:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  8003f8:	8b 13                	mov    (%ebx),%edx
  8003fa:	8d 42 01             	lea    0x1(%edx),%eax
  8003fd:	89 03                	mov    %eax,(%ebx)
  8003ff:	8b 4d 08             	mov    0x8(%ebp),%ecx
  800402:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
	if (b->idx == 256-1) {
  800406:	3d ff 00 00 00       	cmp    $0xff,%eax
  80040b:	75 19                	jne    800426 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80040d:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800414:	00 
  800415:	8d 43 08             	lea    0x8(%ebx),%eax
  800418:	89 04 24             	mov    %eax,(%esp)
  80041b:	e8 96 fc ff ff       	call   8000b6 <sys_cputs>
		b->idx = 0;
  800420:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  800426:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800465:	c7 04 24 ee 03 80 00 	movl   $0x8003ee,(%esp)
  80046c:	e8 ad 01 00 00       	call   80061e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800484:	e8 2d fc ff ff       	call   8000b6 <sys_cputs>
