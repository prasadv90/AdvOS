...
sys_env_destroy(envid_t envid)
{
  ...
  80010a:	00 
  80010b:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  800112:	00 
  800113:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011a:	00 
  80011b:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  800122:	e8 5b 02 00 00       	call   800382 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019c:	00 
  80019d:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  8001a4:	00 
  8001a5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001ac:	00 
  8001ad:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  8001b4:	e8 c9 01 00 00       	call   800382 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ef:	00 
  8001f0:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  8001f7:	00 
  8001f8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001ff:	00 
  800200:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  800207:	e8 76 01 00 00       	call   800382 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800242:	00 
  800243:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  80024a:	00 
  80024b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800252:	00 
  800253:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  80025a:	e8 23 01 00 00       	call   800382 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800295:	00 
  800296:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  80029d:	00 
  80029e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a5:	00 
  8002a6:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  8002ad:	e8 d0 00 00 00       	call   800382 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e8:	00 
  8002e9:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  8002f0:	00 
  8002f1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f8:	00 
  8002f9:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  800300:	e8 7d 00 00 00       	call   800382 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800326:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  80035d:	00 
  80035e:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  800365:	00 
  800366:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80036d:	00 
  80036e:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  800375:	e8 08 00 00 00       	call   800382 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800385:	56                   	push   %esi
  800386:	53                   	push   %ebx
  800387:	83 ec 20             	sub    $0x20,%esp
	va_list ap;

	va_start(ap, fmt);
  80038a:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80038d:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800393:	e8 97 fd ff ff       	call   80012f <sys_getenvid>
  800398:	8b 55 0c             	mov    0xc(%ebp),%edx
  80039b:	89 54 24 10          	mov    %edx,0x10(%esp)
  80039f:	8b 55 08             	mov    0x8(%ebp),%edx
  8003a2:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8003a6:	89 74 24 08          	mov    %esi,0x8(%esp)
  8003aa:	89 44 24 04          	mov    %eax,0x4(%esp)
  8003ae:	c7 04 24 d8 10 80 00 	movl   $0x8010d8,(%esp)
  8003b5:	e8 c1 00 00 00       	call   80047b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8003ba:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8003be:	8b 45 10             	mov    0x10(%ebp),%eax
  8003c1:	89 04 24             	mov    %eax,(%esp)
  8003c4:	e8 51 00 00 00       	call   80041a <vcprintf>
	cprintf("\n");
  8003c9:	c7 04 24 fc 10 80 00 	movl   $0x8010fc,(%esp)
  8003d0:	e8 a6 00 00 00       	call   80047b <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8003d5:	cc                   	int3   
  8003d6:	eb fd                	jmp    8003d5 <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  8003f5:	75 19                	jne    800410 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8003f7:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8003fe:	00 
  8003ff:	8d 43 08             	lea    0x8(%ebx),%eax
  800402:	89 04 24             	mov    %eax,(%esp)
  800405:	e8 96 fc ff ff       	call   8000a0 <sys_cputs>
		b->idx = 0;
  80040a:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  800410:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800445:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  80044b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80044f:	c7 04 24 d8 03 80 00 	movl   $0x8003d8,(%esp)
  800456:	e8 b3 01 00 00       	call   80060e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  80045b:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  800461:	89 44 24 04          	mov    %eax,0x4(%esp)
  800465:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  80046b:	89 04 24             	mov    %eax,(%esp)
  80046e:	e8 2d fc ff ff       	call   8000a0 <sys_cputs>

	return b.cnt;
}
  800473:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  800479:	c9                   	leave  
  80047a:	c3                   	ret    
...
cprintf(const char *fmt, ...)
{
  ...
  80048e:	e8 87 ff ff ff       	call   80041a <vcprintf>
	va_end(ap);
