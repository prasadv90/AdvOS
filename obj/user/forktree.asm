...
forktree(const char *cur)
{
  ...
  800051:	e8 a6 01 00 00       	call   8001fc <cprintf>
...
forkchild(const char *cur, char branch)
{
  ...
  8000a4:	c7 44 24 08 b1 11 80 	movl   $0x8011b1,0x8(%esp)
  8000ab:	00 
  ...
  8000ba:	e8 fb 06 00 00       	call   8007ba <snprintf>
	if (fork() == 0) {
  8000bf:	e8 94 0d 00 00       	call   800e58 <fork>
...
umain(int argc, char **argv)
{
  ...
  8000e2:	83 ec 18             	sub    $0x18,%esp
	forktree("");
  8000e5:	c7 04 24 b0 11 80 00 	movl   $0x8011b0,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  8000fe:	8b 75 0c             	mov    0xc(%ebp),%esi
	...
	thisenv = 0;
  800101:	c7 05 04 20 80 00 00 	movl   $0x0,0x802004
  800108:	00 00 00 
...
exit(void)
{
  ...
  800152:	e8 5c 0a 00 00       	call   800bb3 <sys_env_destroy>
}
  800157:	c9                   	leave  
  800158:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  800176:	75 19                	jne    800191 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  800178:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  80017f:	00 
  800180:	8d 43 08             	lea    0x8(%ebx),%eax
  800183:	89 04 24             	mov    %eax,(%esp)
  800186:	e8 eb 09 00 00       	call   800b76 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001d0:	c7 04 24 59 01 80 00 	movl   $0x800159,(%esp)
  8001d7:	e8 b2 01 00 00       	call   80038e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8001ef:	e8 82 09 00 00       	call   800b76 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028f:	e8 6c 0c 00 00       	call   800f00 <__udivdi3>
  ...
  8002f8:	0f be 80 c0 11 80 00 	movsbl 0x8011c0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800413:	ff 24 8d 80 12 80 00 	jmp    *0x801280(,%ecx,4)
  ...
  8004df:	c7 44 24 08 e1 11 80 	movl   $0x8011e1,0x8(%esp)
  8004e6:	00 
  ...
  800511:	b8 d1 11 80 00       	mov    $0x8011d1,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800be0:	00 
  800be1:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800be8:	00 
  800be9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf0:	00 
  800bf1:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c72:	00 
  800c73:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800c7a:	00 
  800c7b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c82:	00 
  800c83:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cc5:	00 
  800cc6:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800ccd:	00 
  800cce:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd5:	00 
  800cd6:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d18:	00 
  800d19:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800d20:	00 
  800d21:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d28:	00 
  800d29:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d6b:	00 
  800d6c:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800d73:	00 
  800d74:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d7b:	00 
  800d7c:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dbe:	00 
  800dbf:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800dc6:	00 
  800dc7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dce:	00 
  800dcf:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e33:	00 
  800e34:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800e3b:	00 
  800e3c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e43:	00 
  800e44:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
fork(void)
{
  ...
  800e5e:	c7 44 24 08 3f 14 80 	movl   $0x80143f,0x8(%esp)
  800e65:	00 
  800e66:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800e6d:	00 
  800e6e:	c7 04 24 33 14 80 00 	movl   $0x801433,(%esp)
...
sfork(void)
{
  ...
  800e80:	c7 44 24 08 3e 14 80 	movl   $0x80143e,0x8(%esp)
  800e87:	00 
  800e88:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800e8f:	00 
  800e90:	c7 04 24 33 14 80 00 	movl   $0x801433,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ec8:	c7 04 24 54 14 80 00 	movl   $0x801454,(%esp)
  800ecf:	e8 28 f3 ff ff       	call   8001fc <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ed4:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800ed8:	8b 45 10             	mov    0x10(%ebp),%eax
  800edb:	89 04 24             	mov    %eax,(%esp)
  800ede:	e8 b8 f2 ff ff       	call   80019b <vcprintf>
	cprintf("\n");
  800ee3:	c7 04 24 af 11 80 00 	movl   $0x8011af,(%esp)
  800eea:	e8 0d f3 ff ff       	call   8001fc <cprintf>
