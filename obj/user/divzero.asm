...
umain(int argc, char **argv)
{
  ...
  80005b:	e8 0b 01 00 00       	call   80016b <cprintf>
}
  800060:	c9                   	leave  
  800061:	c3                   	ret    
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800268:	0f be 80 d8 10 80 00 	movsbl 0x8010d8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800383:	ff 24 8d a0 11 80 00 	jmp    *0x8011a0(,%ecx,4)
  ...
  80044f:	c7 44 24 08 f9 10 80 	movl   $0x8010f9,0x8(%esp)
  800456:	00 
  ...
  800481:	b8 e9 10 80 00       	mov    $0x8010e9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b50:	00 
  800b51:	c7 44 24 08 28 13 80 	movl   $0x801328,0x8(%esp)
  800b58:	00 
  800b59:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b60:	00 
  800b61:	c7 04 24 45 13 80 00 	movl   $0x801345,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800be2:	00 
  800be3:	c7 44 24 08 28 13 80 	movl   $0x801328,0x8(%esp)
  800bea:	00 
  800beb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf2:	00 
  800bf3:	c7 04 24 45 13 80 00 	movl   $0x801345,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c35:	00 
  800c36:	c7 44 24 08 28 13 80 	movl   $0x801328,0x8(%esp)
  800c3d:	00 
  800c3e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c45:	00 
  800c46:	c7 04 24 45 13 80 00 	movl   $0x801345,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c88:	00 
  800c89:	c7 44 24 08 28 13 80 	movl   $0x801328,0x8(%esp)
  800c90:	00 
  800c91:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c98:	00 
  800c99:	c7 04 24 45 13 80 00 	movl   $0x801345,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cdb:	00 
  800cdc:	c7 44 24 08 28 13 80 	movl   $0x801328,0x8(%esp)
  800ce3:	00 
  800ce4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ceb:	00 
  800cec:	c7 04 24 45 13 80 00 	movl   $0x801345,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d2e:	00 
  800d2f:	c7 44 24 08 28 13 80 	movl   $0x801328,0x8(%esp)
  800d36:	00 
  800d37:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3e:	00 
  800d3f:	c7 04 24 45 13 80 00 	movl   $0x801345,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800da3:	00 
  800da4:	c7 44 24 08 28 13 80 	movl   $0x801328,0x8(%esp)
  800dab:	00 
  800dac:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800db3:	00 
  800db4:	c7 04 24 45 13 80 00 	movl   $0x801345,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800df4:	c7 04 24 54 13 80 00 	movl   $0x801354,(%esp)
  800dfb:	e8 6b f3 ff ff       	call   80016b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e00:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e04:	8b 45 10             	mov    0x10(%ebp),%eax
  800e07:	89 04 24             	mov    %eax,(%esp)
  800e0a:	e8 fb f2 ff ff       	call   80010a <vcprintf>
	cprintf("\n");
  800e0f:	c7 04 24 cc 10 80 00 	movl   $0x8010cc,(%esp)
  800e16:	e8 50 f3 ff ff       	call   80016b <cprintf>
