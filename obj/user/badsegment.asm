...
libmain(int argc, char **argv)
{
  ...
  800056:	e8 d8 00 00 00       	call   800133 <sys_getenvid>
...
sys_env_destroy(envid_t envid)
{
  ...
  80010e:	00 
  80010f:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  800116:	00 
  800117:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011e:	00 
  80011f:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  800126:	e8 5b 02 00 00       	call   800386 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a0:	00 
  8001a1:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  8001a8:	00 
  8001a9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b0:	00 
  8001b1:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  8001b8:	e8 c9 01 00 00       	call   800386 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f3:	00 
  8001f4:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  8001fb:	00 
  8001fc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800203:	00 
  800204:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  80020b:	e8 76 01 00 00       	call   800386 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800246:	00 
  800247:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  80024e:	00 
  80024f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800256:	00 
  800257:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  80025e:	e8 23 01 00 00       	call   800386 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800299:	00 
  80029a:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  8002a1:	00 
  8002a2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a9:	00 
  8002aa:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  8002b1:	e8 d0 00 00 00       	call   800386 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002ec:	00 
  8002ed:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  8002f4:	00 
  8002f5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002fc:	00 
  8002fd:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  800304:	e8 7d 00 00 00       	call   800386 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800321:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
sys_ipc_recv(void *dstva)
{
  ...
  800361:	00 
  800362:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  800369:	00 
  80036a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800371:	00 
  800372:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
  800379:	e8 08 00 00 00       	call   800386 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800397:	e8 97 fd ff ff       	call   800133 <sys_getenvid>
  ...
  8003b2:	c7 04 24 d8 10 80 00 	movl   $0x8010d8,(%esp)
  ...
  8003c8:	e8 51 00 00 00       	call   80041e <vcprintf>
	cprintf("\n");
  8003cd:	c7 04 24 fc 10 80 00 	movl   $0x8010fc,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  800409:	e8 96 fc ff ff       	call   8000a4 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80045a:	e8 af 01 00 00       	call   80060e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800472:	e8 2d fc ff ff       	call   8000a4 <sys_cputs>
