	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 c8 10 80 00 	movsbl 0x8010c8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80041f:	c7 44 24 08 e0 10 80 	movl   $0x8010e0,0x8(%esp)
  800426:	00 
  ...
  80043f:	c7 44 24 08 e9 10 80 	movl   $0x8010e9,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 d9 10 80 00       	mov    $0x8010d9,%eax
