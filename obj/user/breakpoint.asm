...
libmain(int argc, char **argv)
{
  ...
  800051:	e8 d8 00 00 00       	call   80012e <sys_getenvid>
...
sys_env_destroy(envid_t envid)
{
  ...
  800109:	00 
  80010a:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  800111:	00 
  800112:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800119:	00 
  80011a:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019b:	00 
  80019c:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  8001a3:	00 
  8001a4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001ab:	00 
  8001ac:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ee:	00 
  8001ef:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  8001f6:	00 
  8001f7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fe:	00 
  8001ff:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800241:	00 
  800242:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  800249:	00 
  80024a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800251:	00 
  800252:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800294:	00 
  800295:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  80029c:	00 
  80029d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a4:	00 
  8002a5:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e7:	00 
  8002e8:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  8002ef:	00 
  8002f0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f7:	00 
  8002f8:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  80035c:	00 
  80035d:	c7 44 24 08 aa 10 80 	movl   $0x8010aa,0x8(%esp)
  800364:	00 
  800365:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80036c:	00 
  80036d:	c7 04 24 c7 10 80 00 	movl   $0x8010c7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003ad:	c7 04 24 d8 10 80 00 	movl   $0x8010d8,(%esp)
  ...
  8003c3:	e8 51 00 00 00       	call   800419 <vcprintf>
	cprintf("\n");
  8003c8:	c7 04 24 fc 10 80 00 	movl   $0x8010fc,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800455:	e8 b4 01 00 00       	call   80060e <vprintfmt>
	sys_cputs(b.buf, b.idx);
